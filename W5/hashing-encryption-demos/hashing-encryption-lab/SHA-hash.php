...
<head>
<body>
<h1> SHA (Secure Hash Algorithm) Hashing</h1>
...
if(isset($_POST['passwort'])){
	...
	$hsh1 = sha1 ($passwort);
	$hsh256 = hash('sha256', $passwort);
	echo '<p>Das Passwort "<strong>'.$passwort.'</strong>" hat folgenden SHA1 Hash ergeben: </p>';
	echo '<p class="box"><strong>'.$hsh1.'</strong></p>';
	echo '<p>Das Passwort "<strong>'.$passwort.'</strong>" hat folgenden SHA256 Hash ergeben: </p>';
	echo '<p class="box"><strong>'.$hsh256.'</strong></p>';
}else{
